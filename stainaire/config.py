...
class Config(AttrDict):
    ...
    def __init__(self, filename=None, verbose=False):
        ...
        # Networks.
        self.gen = AttrDict(type='stainaire.generators.dummy')
        self.dis = AttrDict(type='stainaire.discriminators.dummy')
        ...
        self.data = AttrDict(name='dummy',
                             type='stainaire.datasets.images',
                             num_workers=0)
...
# Cudnn.
        ...
        if verbose:
            print(' stainaire config '.center(80, '-'))
            print(self.__repr__())
            print(''.center(80, '-'))
