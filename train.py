...
from stainaire.config import Config
from stainaire.utils.cudnn import init_cudnn
from stainaire.utils.dataset import get_train_and_val_dataloader
from stainaire.utils.distributed import init_dist
from stainaire.utils.distributed import master_only_print as print
from stainaire.utils.gpu_affinity import set_affinity
from stainaire.utils.logging import init_logging, make_logging_dir
from stainaire.utils.trainer import (get_model_optimizer_and_scheduler,
...
def main():
    ...
    shutil.copyfile(args.config, os.path.join(cfg.logdir, 'config.yaml'))
